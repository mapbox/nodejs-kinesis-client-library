...
if (args.help) {
  ...
  console.log('--awsKinesis.[option] [Option value]  (e.g. --awsKinesis.region eu-west-1) If your kinesis stream is in a different region')
...
var opts = {
  ...
  awsConfig: args.aws,
  awsKinesisConfig: args.awsKinesis || args.aws,
